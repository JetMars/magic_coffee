...
import styles from './CheckedSVG.module.scss';
		...
		>
			<g id='Switch/False/True'>
				<path
					...
					fill='#34C759'
				/>
				<g id='knob' filter='url(#filter0_dd_2_2643)'>
					<path
						fillRule='evenodd'
						clipRule='evenodd'
			...
			<defs>
				...
				>
					...
					<feBlend
						...
						result='effect1_dropShadow_2_2643'
					/>
					<feColorMatrix
						in='SourceAlpha'
						type='matrix'
					...
					<feBlend
						mode='normal'
						in2='effect1_dropShadow_2_2643'
						result='effect2_dropShadow_2_2643'
					/>
					<feBlend
						mode='normal'
						in='SourceGraphic'
						in2='effect2_dropShadow_2_2643'
						result='shape'
					/>
				</filter>
			</defs>
